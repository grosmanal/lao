 ...
 */
final class Version20210906134017 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__care_request AS SELECT id, patient_id, doctor_creator_id, complaint_id, accepted_by_doctor_id, creation_date, priority, custom_complaint, accepted_date, abandon_reason FROM care_request');
        ...
        , priority BOOLEAN NOT NULL, custom_complaint VARCHAR(255) DEFAULT NULL COLLATE BINARY, accepted_date DATE DEFAULT NULL --(DC2Type:date_immutable)
        , abandon_reason VARCHAR(10) DEFAULT NULL COLLATE BINARY, abandon_date DATE DEFAULT NULL --(DC2Type:date_immutable)
        ...
        $this->addSql('INSERT INTO care_request (id, patient_id, doctor_creator_id, complaint_id, accepted_by_doctor_id, creation_date, priority, custom_complaint, accepted_date, abandon_reason) SELECT id, patient_id, doctor_creator_id, complaint_id, accepted_by_doctor_id, creation_date, priority, custom_complaint, accepted_date, abandon_reason FROM __temp__care_request');
    ...
    public function down(Schema $schema): void
    {
        ...
        , abandon_reason VARCHAR(10) DEFAULT NULL, state VARCHAR(10) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO care_request (id, patient_id, doctor_creator_id, complaint_id, accepted_by_doctor_id, creation_date, priority, custom_complaint, accepted_date, abandon_reason) SELECT id, patient_id, doctor_creator_id, complaint_id, accepted_by_doctor_id, creation_date, priority, custom_complaint, accepted_date, abandon_reason FROM __temp__care_request');
        $this->addSql('DROP TABLE __temp__care_request');
        $this->addSql('CREATE INDEX IDX_7BF611AA6B899279 ON care_request (patient_id)');
        $this->addSql('CREATE INDEX IDX_7BF611AA56352737 ON care_request (doctor_creator_id)');
