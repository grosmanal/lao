 ...
 */
final class Version20210906135220 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__care_request AS SELECT id, patient_id, doctor_creator_id, complaint_id, accepted_by_doctor_id, creation_date, priority, custom_complaint, abandon_reason, abandon_date, accept_date FROM care_request');
        ...
        $this->addSql('INSERT INTO care_request (id, patient_id, doctor_creator_id, complaint_id, accepted_by_doctor_id, creation_date, priority, custom_complaint, abandon_reason, abandon_date, accept_date) SELECT id, patient_id, doctor_creator_id, complaint_id, accepted_by_doctor_id, creation_date, priority, custom_complaint, abandon_reason, abandon_date, accept_date FROM __temp__care_request');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE care_request');
        $this->addSql('CREATE TABLE care_request (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, patient_id INTEGER NOT NULL, doctor_creator_id INTEGER DEFAULT NULL, complaint_id INTEGER DEFAULT NULL, accepted_by_doctor_id INTEGER DEFAULT NULL, creation_date DATETIME NOT NULL --(DC2Type:datetime_immutable)
        , priority BOOLEAN NOT NULL, custom_complaint VARCHAR(255) DEFAULT NULL, accept_date DATE DEFAULT NULL --(DC2Type:date_immutable)
        , abandon_date DATE DEFAULT NULL --(DC2Type:date_immutable)
        , abandon_reason VARCHAR(10) DEFAULT NULL)');
        $this->addSql('INSERT INTO care_request (id, patient_id, doctor_creator_id, complaint_id, accepted_by_doctor_id, creation_date, priority, custom_complaint, accept_date, abandon_date, abandon_reason) SELECT id, patient_id, doctor_creator_id, complaint_id, accepted_by_doctor_id, creation_date, priority, custom_complaint, accept_date, abandon_date, abandon_reason FROM __temp__care_request');
        $this->addSql('DROP TABLE __temp__care_request');
        $this->addSql('CREATE INDEX IDX_7BF611AA6B899279 ON care_request (patient_id)');
        $this->addSql('CREATE INDEX IDX_7BF611AA56352737 ON care_request (doctor_creator_id)');
        $this->addSql('CREATE INDEX IDX_7BF611AAEDAE188E ON care_request (complaint_id)');
