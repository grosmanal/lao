 ...
 */
final class Version20211113122132 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notification (id INT AUTO_INCREMENT NOT NULL, comment_id INT NOT NULL, doctor_id INT NOT NULL, state VARCHAR(255) NOT NULL, INDEX IDX_BF5476CAF8697D13 (comment_id), INDEX IDX_BF5476CA87F4FB17 (doctor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
