 ...
 */
final class Version20211203095556 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE care_request (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, doctor_creator_id INT DEFAULT NULL, complaint_id INT DEFAULT NULL, accepted_by_doctor_id INT DEFAULT NULL, abandon_reason_id INT DEFAULT NULL, creation_date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', priority TINYINT(1) DEFAULT NULL, custom_complaint VARCHAR(255) DEFAULT NULL, accept_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', abandon_date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_7BF611AA6B899279 (patient_id), INDEX IDX_7BF611AA56352737 (doctor_creator_id), INDEX IDX_7BF611AAEDAE188E (complaint_id), INDEX IDX_7BF611AA3B84A2A7 (accepted_by_doctor_id), INDEX IDX_7BF611AA5E4DA3C0 (abandon_reason_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
