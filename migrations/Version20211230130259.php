 ...
 */
final class Version20211230130259 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE care_request (id INT AUTO_INCREMENT NOT NULL, patient_id INT NOT NULL, contacted_by_id INT DEFAULT NULL, complaint_id INT DEFAULT NULL, accepted_by_id INT DEFAULT NULL, abandoned_by_id INT DEFAULT NULL, abandoned_reason_id INT DEFAULT NULL, created_by_id INT NOT NULL, modified_by_id INT DEFAULT NULL, contacted_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', priority TINYINT(1) DEFAULT NULL, custom_complaint VARCHAR(5000) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, accepted_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', abandoned_at DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', modified_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_7BF611AA710C21C6 (abandoned_by_id), INDEX IDX_7BF611AAFDAAB487 (contacted_by_id), INDEX IDX_7BF611AA28B67853 (abandoned_reason_id), INDEX IDX_7BF611AAEDAE188E (complaint_id), INDEX IDX_7BF611AAB03A8386 (created_by_id), INDEX IDX_7BF611AA20F699D9 (accepted_by_id), INDEX IDX_7BF611AA6B899279 (patient_id), INDEX IDX_7BF611AA99049ECE (modified_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf($this->connection->getDatabasePlatform()->getName() !== 'mysql', 'Migration can only be executed safely on \'mysql\'.');
