        ...
        $builder
            ...
            ->add('complaint', EntityType::class, [
                ...
                'choice_value' => function (?Complaint $complaint) {
                    return $complaint ?
                        $this->urlGenerator->generate('api_complaints_get_item', ['id' => $complaint->getId()]) :
                        ''
                    ;
                },
                'disabled' => $fieldDisabled,
        ...
        if ($careRequest->getId()) {
            ...
            $builder->add('patientUri', HiddenType::class, [
                'data' => $this->urlGenerator->generate(
                    'api_patients_get_item',
                    ['id' => $options['patient']->getId()]
                ),
                'mapped' => false,
            ]);
        }
            ...
            $builder
                    ...
                    'choice_value' => function (?AbandonReason $abandonReason) {
                        return $abandonReason ?
                            $this->urlGenerator->generate(
                                'api_abandon_reasons_get_item',
                                ['id' => $abandonReason->getId()]
                            ) :
                            ''
                        ;
                    },
                ...
                ->add('doctorUri', HiddenType::class, [
                    'data' => $this->urlGenerator->generate(
                        ...
                        ['id' => $options['current_doctor']->getId()]
                    ),
                    'mapped' => false,
                ])
            ;
